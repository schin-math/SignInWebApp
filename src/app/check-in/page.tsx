	...
	return (
		<div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
			<div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
				<h1 className="text-2xl font-bold text-gray-900 mb-6 text-center">Check In</h1>
					...
					{isInRange && (
						<div>
							<div className="text-center mb-4">
								<p className="text-gray-600">Please fill out the form below to complete your check-in.</p>
							</div>
